...
layout = html.Div([  # This is the main layout of the app
    ...
    html.Div([
        html.Div([
            ...
            # Filter Syntax box in a div for layout
            html.Div([
                # Adding the new box for Filter Syntax Reference Guide
                dmc.Tooltip(
                        withArrow=True,
                        width=200,
                        multiline=True,
                        ...
                        transition="fade",
                        transitionDuration=300,
                        # label="Filter Syntax Reference Guide",
                        label=(
                            "=FILTER"
                            " Equal to filter"
                            "<FILTER"
                        ...
                        children=dmc.Button(
                            ...
                            leftIcon=DashIconify(icon="fluent:question-circle-16-regular", width=23), # Icon representing a question mark
                        ),
                        style={"marginLeft": "0.5rem", "marginBottom": "1rem"}  # Adjust margins as needed
                ),
            ]),
